...
export default function PinScrollSection({ items }: Props) {
  ...
  const totalPages = isPhone ? items.length : Math.ceil(items.length / 2);
      ...
      <div style={{ padding: '0 1rem' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '1.25rem' }}>
          <p style={{
            ...
            fontFamily: 'var(--font-english)', marginBottom: '0.5rem',
          }}>
            Why SafeD?
          </p>
          <h2 style={{
            fontSize: isTablet ? '1.25rem' : '1.15rem', fontWeight: 800, lineHeight: 1.3,
                ...
                <div key={i} style={{ width: '100%', flexShrink: 0, padding: '0 2px' }}>
                  <div style={{
                    ...
                    {item.image && (
                      <div style={{
                        ...
                        <div style={{
                          ...
                          background: 'linear-gradient(to bottom, transparent 30%, rgba(255,255,255,0.6) 75%, #fff 100%)',
                        }} />
                        {/* Stat badge on image */}
                        <div style={{
                          ...
                          <span style={{
                            ...
                            background: 'linear-gradient(135deg, #60a5fa, #00c6ff)',
                            WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent',
                            fontFamily: 'var(--font-english)',
                          }}>
                            {item.stat}
                          </span>
                          <span style={{ fontSize: '9px', color: 'rgba(255,255,255,0.6)', fontWeight: 500 }}>
                            {item.statLabel}
                          </span>
                        </div>
                      </div>
                    ...
                    <div style={{ padding: '0.75rem 1rem 1rem' }}>
                      ...
                      <h3 style={{
                        fontSize: '0.9rem', fontWeight: 800, lineHeight: 1.3,
                        letterSpacing: '-0.3px', margin: '0.3rem 0 0.4rem',
              ...
              Array.from({ length: totalPages }).map((_, pageIdx) => {
                ...
                return (
                  <div key={pageIdx} style={{
                    display: 'flex', gap: '8px', width: '100%', flexShrink: 0,
                  }}>
                      ...
                      return (
                        <div key={gi} style={{
                          ...
                          <div style={{
                            ...
                            <h3 style={{
                              fontSize: '0.8rem', fontWeight: 800, lineHeight: 1.25,
                              letterSpacing: '-0.3px', marginBottom: '0.25rem',
                              color: '#111', whiteSpace: 'pre-line',
                            }}>
                              {item.headline}
                            </h3>
                            <div style={{
                              ...
                              padding: '4px 10px', border: '1px solid rgba(0,123,255,0.1)',
        ...
        {/* Dots */}
        <div style={{
          display: 'flex', justifyContent: 'center', gap: '5px', marginTop: '0.75rem',
        }}>
          {Array.from({ length: totalPages }).map((_, i) => (
            <button key={i} onClick={() => goSlide(i)} aria-label={`${i + 1}`} style={{
